...
<head>
    ...
    <style>
        ...
        *{font-family:'Plus Jakarta Sans',sans-serif;box-sizing:border-box;}
        ...
        .logout-modal-icon svg{width:28px;height:28px;color:#dc2626;}
    ...
    <div class="logout-modal-card">
        <div style="padding:2rem 1.75rem 1.5rem;text-align:center;">
            <div class="logout-modal-icon">
                <svg fill="none" stroke="#dc2626" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg>
            </div>
            <p style="font-size:1.125rem;font-weight:700;color:#0f172a;margin-bottom:0.5rem;">Confirm Logout</p>
            <p style="font-size:0.875rem;color:#64748b;line-height:1.6;">Are you sure you want to log out of your admin session? Any unsaved changes will be lost.</p>
        </div>
